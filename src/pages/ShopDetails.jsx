...
function ShopDetails() {
  return (
    ...
    <main>
                ...
                <div className="row">
					<div className="col-lg-12">
                        <div className="breadcrumb-text">
                            <h1 className="title wow fadeInUp" data-wow-delay="0.1s">Shop Details</h1>
                            <nav aria-label="breadcrumb" className="breadcrumb-nav wow fadeInUp" data-wow-delay="0.0s">
                                <ul className="breadcrumb listing">
                                    ...
                                    <li className="breadcrumb-item single-list" aria-current="page"><a href="#"
                                            className="single active">Shop Details</a></li>
                                </ul>
                            </nav>
                        </div>						
					</div>
        ...
        <section className="product-details-area top-padding">
            <div className="container">
                <div className="row g-4">
                    <div className="col-xxl-6 col-lg-6">
                        <div className="product-image-container">
                            <div className="xzoom-box">
                                <img className="xzoom" src="/assets/images/product/main-img-01.png"
                            ...
                            <div className="xzoom-thumbs">
                                <div className="xzoom-gallery-box">
                                    <a href="/assets/images/product/main-img-01.png">
                                        <img className="xzoom-gallery" width="80"
                        ...
                        <div className="product-details-content">
                            <div className="first-section">
                                <div className="category-name">
                                    <p className="pera"><span className="highlight">Category: </span>Furniture, Armchairs</p>
                                </div>
                                <h4 className="product-name">Bracelet Armchair Fendi Casa</h4>
                                <div className="product-price-section">
                                    <div className="price-section">
                                        <h4 className="price discounted">$800</h4>
                                    ...
                                    <div className="ratting-section">
                                        ...
                                        <div className="ratting-count">
                                            <p className="pera">6 Reviews</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="stock-section">
                                    <p className="stock-count highlight">45 In stock</p>
                                    <p className="stock-count">( Sold 21 Products in last
                                        10 Hours )</p>
                                </div>
                                ...
                                <div className="product-desc">
                                    ...
                                    <div className="d-flex gap-16 flex-wrap">
                                        <div className="wish-list">
                                            ...
                                            <a href="#">
                                                <p className="pera">add to wishlist</p>
                                            </a>
                                        </div>
                                        <div className="compare-section">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16"
                                                ...
                                                <path
                                                    ...
                                                    fill="#AD8C5C" stroke="#AD8C5C" strokeWidth="0.2" />
                                                <path
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-md-9">
                                        <div className="quantity-section">
                                            <div className="quantity-btn position-relative">
                                                <input type="text" name="qty" value="01" className="num-count" />

                                                <button className="increase-num">
                                    ...
                                    <div className="col-md-9">
                                        <div className="size-dropdown">
                                            <select name="size" className="select2">
                                    ...
                                    <div className="col-md-3">
                                        <h4 className="label">SKU</h4>
                                    </div>
                                    <div className="col-md-9">
                                        <p className="info">KE-91039</p>
                                    </div>
                                    <div className="col-md-3">
                                        <h4 className="label">Tags</h4>
                                    </div>
                                    <div className="col-md-9">
                                        <p className="info mb-19">Chairs, Sofa, Single Sofa</p>
                                        <p className="info highlighter d-flex align-items-center"><svg className="mr-10"
                ...
                <div className="more-details-section">
                    <div className="row g-4">
                        <div className="col-xl-5">
                            ...
                            <div className="all-outline-btn">
                                <ul className="nav all-outline-btn" id="pills-tab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                      <button className="nav-link outline-pill-btn active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                                    ...
                                    <li className="nav-item" role="presentation">
                                      <button className="nav-link outline-pill-btn " id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                                    ...
                                    <li className="nav-item" role="presentation">
                                      <button className="nav-link outline-pill-btn " id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">
                                ...
                                <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div className="addition-desc">
                                        ...
                                        <ul className="listings">
                                            <li className="list">
                                                <p className="points">Aenean auctor sem ac ex efficitur</p>
                                            </li>
                                            <li className="list">
                                                <p className="points"> Non mattis odio bibendum</p>
                                            </li>
                                            <li className="list">
                                                <p className="points"> Sed vitae enim at tortor finibus</p>
                                            </li>
                                            <li className="list">
                                                <p className="points"> Integer facilisis eleifend vehicula</p>
                                            </li>
                                            <li className="list">
                                                <p className="points"> In hac habitasse platea dictumst</p>
                                            </li>
                                        </ul>
                                        <p className="pera">
                                    ...
                                    <div className="addition-desc">
                                        <div className="table-responsive mb-20">
                                            <table className="table custom-table table-striped">
                                                <tbody>
                                                    <tr>
                                                        <th className="thead">HEIGHT</th>
                                                        <td className="tdata">Inches (34.6)</td>
                                                        <td className="tdata">CM (88)</td>
                                                    </tr>
                                                    <tr>
                                                        <th className="thead">WIDTH</th>
                                                        <td className="tdata">Inches (71.7 X 89.4)</td>
                                                        <td className="tdata">CM (182 X 227)</td>
                                                    </tr>
                                                    <tr>
                                                        <th className="thead">DEPTH</th>
                                                        <td className="tdata">Inches (35.8)</td>
                                                        <td className="tdata">CM (91)</td>
                                                    </tr>
                                                    <tr>
                                                        <th className="thead">INTERNAL</th>
                                                        <td className="tdata">Inches (57.1 X 68.1)</td>
                                                        <td className="tdata">CM (145 X 173)</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div className="wrap-user">
                                                ...
                                                <div className="wrap-info">
                                                    <div className="user-info">
                                                        <div className="name-ratting">
                                                            <div className="name-wrapper">
                                                                <h4 className="name">Abubokkor Siddik</h4>
                                                    ...
                                                    <div className="user-comment">
                                                        <p className="pera">Simply dummy text of the printing and typesetting
                                            ...
                                            <div className="wrap-user">
                                                ...
                                                <div className="wrap-info">
                                                    <div className="user-info">
                                                        <div className="name-ratting">
                                                            <div className="name-wrapper">
                                                                <h4 className="name">Davidthy Phillips</h4>
                                                                <div className="ratting">
                                                                    <div className="all-ratting">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                                                            height="14" viewBox="0 0 14 14" fill="none">
                                            ...
                                            <div className="wrap-user">
                                                ...
                                                <div className="wrap-info">
                                                    <div className="user-info">
                                                        <div className="name-ratting">
                                                            <div className="name-wrapper">
                                                                <h4 className="name">Elliot Alderson</h4>
                                                                <div className="ratting">
                                                                    <div className="all-ratting">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                                                            height="14" viewBox="0 0 14 14" fill="none">
        ...
        <section className="related-product feature-area section-padding2">
            <div className="container">
                <div className="row">
					<div className="col-lg-12">
                                            ...
                                            <div className="button-section">
                                                ...
                                                <div className="fill-pill-btn qty-btn">
                                                    <div className="qty-container best-product-qty-container">
                                                        ...
                                                        <input type="text" name="qty" value="0" className="input-qty input-rounded" />
