                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="breadcrumb-text">
                            <h1 className="title wow fadeInUp" data-wow-delay="0.1s">Blog</h1>
                            <nav aria-label="breadcrumb" className="breadcrumb-nav wow fadeInUp" data-wow-delay="0.0s">
                                <ul className="breadcrumb listing">
                                    ...
                                    <li className="breadcrumb-item single-list" aria-current="page"><a
                                            href="#" className="single active">Blog</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div className="row g-4">
                            <div className="col-sm-6">
                                <div className="news-card">
                                    ...
                                    <div className="news-content">
                                        <a href="/blog-details">
                                            <h4 className="news-title line-clamp-2">Modern studio apartment design bedroom
                                                and living space</h4>
                                        </a>
                                    </div>
                            ...
                            <div className="col-sm-6">
                                <div className="news-card">
                                    ...
                                    <div className="news-content">
                                        <a href="/blog-details">
                                            <h4 className="news-title line-clamp-2">Cafe with coffee tables as sofas plants
                                                and shelves</h4>
                                        </a>
                                    </div>
                                    <a href="/blog-details" className="read-more-text">Read More <svg
                        ...
                        <div className="news-filter">
                            <div className="search-filter-section">
                                ...
                                <div className="search-section">
                                    ...
                                    <div className="search-box mt-26 mb-0">
                                        <input className="custom-form-control" type="search" name="search"
                                            placeholder="Search" />
                                        <div className="icon">
                                    ...
                                    <div className="arrival-product">
                                        <a href="/shop-details">
                                            <div className="product-details">
                                                ...
                                                <div className="product-info">
                                                    <h4 className="name line-clamp-1">Affinity Queen Poster Bed</h4>
                                                    <div className="price-section">
                                                        <h4 className="price discounted">$640</h4>
                                                        <h4 className="price text-color-primary">$570</h4>
                                                    </div>
                                                    <div className="ratting-section">
                                                        <div className="all-ratting">
                                        ...
                                        <a href="/shop-details">
                                            <div className="product-details">
                                                ...
                                                <div className="product-info">
                                                    <h4 className="name line-clamp-1">Mid-Century Modern Cane</h4>
                                                    <div className="price-section">
                                                        <h4 className="price text-color-primary">$640</h4>
                                                    </div>
                                                    <div className="ratting-section">
                                                        <div className="all-ratting">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                        ...
                                        <a href="/shop-details">
                                            <div className="product-details">
                                                ...
                                                <div className="product-info">
                                                    <h4 className="name line-clamp-1">Rift Gogan Sofa Large</h4>
                                                    <div className="price-section">
                                                        <h4 className="price text-color-primary">$640</h4>
                                                    </div>
                                                    <div className="ratting-section">
                                ...
                                <div className="search-section">
                                    ...
                                    <div className="arrival-product latest-post">
                                        <a href="/blog-details">
                                            <div className="product-details">
                                                ...
                                                <div className="product-info">
                                                    <h4 className="line-clamp-2">
                                                        <span className="title-effect name">Dark living room intrior with
                                                    ...
                                                    <div className="date">
                                                        ...
                                                        <p className="pera">16 April 2023</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                        <a href="/blog-details">
                                            <div className="product-details">
                                                ...
                                                <div className="product-info">
                                                    <h4 className="line-clamp-2">
                                                        <span className="title-effect name">Concrete Wall Clock With Leather
                                                            Stripe, Modern</span>
                                                    </h4>
                                                    <div className="date">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                        ...
                                        <a href="/blog-details">
                                            <div className="product-details">
                                                ...
                                                <div className="product-info">
                                                    <h4 className="line-clamp-2">
                                                        <span className="title-effect name">Pleased black girl wearing
                                ...
                                <div className="search-section">
                                    ...
                                    <div className="all-tags-cloud">
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Chairs</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Special Offer</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Bedroom</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Cabinet</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Sofa</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Stool</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Bed</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Decor</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Lamp</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Mattresses</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Office</p>
                                            </a>
                                        </div>
                                        <div className="single-tag">
                                            <a href="#">
                                                <p className="pera">Accent Furniture</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
