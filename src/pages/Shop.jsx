                ...
                <div className="row">
					<div className="col-lg-12">
                        <div className="breadcrumb-text">
                            <h1 className="title wow fadeInUp" data-wow-delay="0.1s">Shop</h1>
                            <nav aria-label="breadcrumb" className="breadcrumb-nav wow fadeInUp" data-wow-delay="0.0s">
                                <ul className="breadcrumb listing">
                                    ...
                                    <li className="breadcrumb-item single-list" aria-current="page"><a href="#"
                                            className="single active">Shop</a></li>
                                </ul>
                            </nav>
                        </div>						
					</div>
                        ...
                        <div className="expand-icon hamburger block d-xl-none" id="hamburger">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path
                                    ...
                                    stroke="#071516" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div className="row g-4">
                    ...
                    <div className="col-xxl-3 col-xl-4">
                        <div className="search-filter-section">
                            ...
                            <div className="search-box">
                                <input className="search-input" type="search" name="search" placeholder="Search Products" />
                                <div className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none">
                                        <path
                            ...
                            <div className="search-section">
                                ...
                                <div className="offer-list">
                                    <div className="d-flex">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Office Chair</p>
                                            <p className="pera">(12)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Dining Chair</p>
                                            <p className="pera">(51)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Office Table</p>
                                            <p className="pera">(10)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Dining Table</p>
                                            <p className="pera">(24)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Bed Light</p>
                                            <p className="pera">(31)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Sofa Set</p>
                                            <p className="pera">(25)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                            ...
                            <div className="search-section">
                                ...
                                <div className="color-section">
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox1" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox2" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox3" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox4" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox5" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox6" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox7" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox8" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox9" />
                                        <div></div>
                                    </div>
                                    <div className="color-checkbox">
                                        <input className="check-color" type="checkbox" id="checkbox10" />
                                        <div></div>
                                    </div>
                                </div>
                            ...
                            <div className="search-section">
                                <div className="heading">
                                    <h4 className="title">Manufactures</h4>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="10" viewBox="0 0 20 10"
                                        fill="none">
                                        <path
                                            d="M20 1.05636C19.9113 0.744994 19.7615 0.47255 19.4676 0.263351C18.9685 -0.0820697 18.2475 -0.0917998 17.7484 0.258486C17.6541 0.326597 17.5598 0.399573 17.4711 0.477415C15.042 2.60832 12.6073 4.74409 10.1782 6.875C10.1228 6.92365 10.0784 6.98203 9.94531 7.0696C9.90649 7.01122 9.88431 6.93824 9.82885 6.88959C7.37757 4.73436 4.92074 2.58399 2.46946 0.428762C2.03688 0.0492861 1.53775 -0.0966664 0.938797 0.0687463C0.0680942 0.312 -0.286842 1.29475 0.262201 1.93694C0.323206 2.00991 0.395302 2.07802 0.467398 2.14614C3.2958 4.62733 6.11865 7.10852 8.94705 9.58485C9.46282 10.0373 10.1172 10.1249 10.7106 9.82323C10.8548 9.75026 10.9824 9.64323 11.0989 9.54106C13.8441 7.13285 16.5837 4.72463 19.3345 2.32128C19.6395 2.0537 19.9113 1.78126 20 1.39692C20 1.28502 20 1.17312 20 1.05636Z"
                                ...
                                <div className="offer-list">
                                    <div className="d-flex">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Hatil Furniture</p>
                                            <p className="pera">(14)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Navana Furniture</p>
                                            <p className="pera">(22)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Akhtar Furnishers</p>
                                            <p className="pera">(10)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Lamp Lighting</p>
                                            <p className="pera">(51)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Otobi Furniture</p>
                                            <p className="pera">(42)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        <label className="checkbox-label">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Nadia Furniture</p>
                                            <p className="pera">(25)</p>
                                        </div>
                                    </div>
                                    <div className="d-flex">
                                        ...
                                        <div className="content pl-24 d-flex justify-content-between w-100">
                                            <p className="pera">Regal Furniture</p>
                                            <p className="pera">(62)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <nav className="pagination-nav">
                    <ul className="pagination">
                        <li className="page-item">
                            <a className="page-link next" href="#" aria-label="Previous"><i
                                    className="ri-arrow-left-s-line"></i></a>
                        </li>
                        <li className="page-item" aria-current="page"><span className="page-link active">01</span></li>
                        <li className="page-item"><a className="page-link" href="#">02</a></li>
                        <li className="page-item"><a className="page-link" href="#">03</a></li>
                        <li className="page-item">
                            <a className="page-link next" href="#" aria-label="Next"><i
